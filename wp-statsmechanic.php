...
class Wp_StatsMechanic extends WP_Widget{
    ...
    function __construct(){
	 $params=array(
            'description' => __('Display Visitor Counter and Statistics Traffic', 'mechanic-visitor-counter'), // Make description translatable
            'name' => __('Mechanic - Visitor Counter', 'mechanic-visitor-counter') // Make name translatable
        );
...
<?php
    ...
    public function widget($args, $instance){
        ...
        echo $args['before_widget']; // Use $args directly
        ...
        foreach ($arr as $value) {
            ...
            if (file_exists(BMW_PATH . $image_path)) {
                 ...
                 $tothitsgbr .= "<img src='" . esc_url( $image_url ) . "' alt='" . esc_attr( $value ) . "' class='mvc-digit-img'>"; // Add class for potential styling
            } else {
        ...
        // --- Output Widget HTML ---
        ?>
        <div id='mvcwid-<?php echo esc_attr($this->id); ?>' class='mvcwid' style='<?php echo $escaped_style_attr; ?>'>
            <div class="mvccount"><?php echo $tothitsgbr; // Contains escaped img tags ?></div>
            <div class="mvctable">
                <table width='100%'>
                    <?php if ($todayview) : ?>
                    <tr><td style='<?php echo $escaped_style_attr; ?>'><?php echo $imgvisit; ?> <?php esc_html_e('Visit Today :', 'mechanic-visitor-counter'); ?> <?php echo esc_html( number_format_i18n( $pengunjung ) ); ?></td></tr>
                    <?php endif; ?>
                    <?php if ($yesview) : ?>
                    <tr><td style='<?php echo $escaped_style_attr; ?>'><?php echo $yesterday; ?> <?php esc_html_e('Visit Yesterday :', 'mechanic-visitor-counter');?> <?php echo esc_html( number_format_i18n( $kemarin1 ) ); ?></td></tr>
                    <?php endif; ?>
                    <?php if ($monthview) : ?>
                    <tr><td style='<?php echo $escaped_style_attr; ?>'><?php echo $month; ?> <?php esc_html_e('This Month :', 'mechanic-visitor-counter'); ?> <?php echo esc_html( number_format_i18n( $bulan1 ) ); ?></td></tr>
                    <?php endif; ?>
                    <?php if ($yearview) : ?>
                    <tr><td style='<?php echo $escaped_style_attr; ?>'><?php echo $year; ?> <?php esc_html_e('This Year :', 'mechanic-visitor-counter'); ?> <?php echo esc_html( number_format_i18n( $tahunini1 ) ); ?></td></tr>
                    <?php endif; ?>
                    <?php if ($totalview) : ?>
                    <tr><td style='<?php echo $escaped_style_attr; ?>'><?php echo $imgtotal; ?> <?php esc_html_e('Total Visit :', 'mechanic-visitor-counter');?> <?php echo esc_html( number_format_i18n( $totalpengunjung + $count_start ) ); ?></td></tr>
                    <?php endif; ?>
                    <?php if ($hitsview) : ?>
                    <tr><td style='<?php echo $escaped_style_attr; ?>'><?php echo $imghits; ?> <?php esc_html_e('Hits Today :', 'mechanic-visitor-counter');?> <?php echo esc_html( number_format_i18n( $hits ) ); ?></td></tr>
                    <?php endif; ?>
                    <?php if ($totalhitsview) : ?>
                    <tr><td style='<?php echo $escaped_style_attr; ?>'><?php echo $imgtotalhits; ?> <?php esc_html_e('Total Hits :','mechanic-visitor-counter');?> <?php
                        $display_total_hits = $totalhits + $hits_start; // Add start value
                        echo esc_html( number_format_i18n( $display_total_hits ) );
                    ?></td></tr>
                    <?php endif; ?>
                    <?php if ($onlineview) : ?>
                    <tr><td style='<?php echo $escaped_style_attr; ?>'><?php echo $imgonline; ?> <?php esc_html_e("Who's Online :", 'mechanic-visitor-counter');?> <?php echo esc_html( number_format_i18n( $pengunjungonline ) ); ?></td></tr>
                    <?php endif; ?>
                </table>
            </div>
            ...
            <div class="mvcserver"><?php esc_html_e('Server Time:', 'mechanic-visitor-counter'); ?> <?php echo esc_html( $tanggal ); // Display the calculated date ?></div>
            <?php endif; ?>
        </div>
        <?php
        echo $args['after_widget']; // Use $args directly
	 }
...
function statsmechanic_menu() {
    ...
    add_options_page(
        __('Mechanic Visitor Counter Options', 'mechanic-visitor-counter'), // Page title
        __('Visitor Counter', 'mechanic-visitor-counter'), // Menu title
...
function statsmechanic_admin_notice__php_error() {
    ...
    printf(
        ...
        esc_attr( $class ),
        sprintf(
            // Use wp_kses_post to allow the <b> tag
